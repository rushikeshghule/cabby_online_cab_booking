...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(choices=[('RIDE_REQUEST', 'Ride Request'), ('RIDE_ACCEPTED', 'Ride Accepted'), ('RIDE_STARTED', 'Ride Started'), ('RIDE_COMPLETED', 'Ride Completed'), ('RIDE_CANCELLED', 'Ride Cancelled'), ('PAYMENT', 'Payment'), ('SYSTEM', 'System')], max_length=20)),
